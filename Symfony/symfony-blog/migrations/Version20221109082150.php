 ...
 */
final class Version20221109082150 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE images (id INT AUTO_INCREMENT NOT NULL, category_id INT DEFAULT NULL, file VARCHAR(255) NOT NULL, num_likes INT NOT NULL, num_views INT NOT NULL, num_downloads INT NOT NULL, INDEX IDX_E01FBE6A12469DE2 (category_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
